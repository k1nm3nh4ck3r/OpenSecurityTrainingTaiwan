...
debug_stack_loop:
	...
	add bx, ax
	add bx,26
	mov dx, word ptr [bx] ; dx = word ptr[ss:sp]
	pop ds
	pop bx
	pop ax
...
print_num_detail:
	...
	mov dx, offset base2str
	call print_string
	call print_ax_withprefix_bin
	
	mov dx, offset base8str
	call print_string
	call print_ax_withprefix_oct
	
	mov dx, offset base10str
	call print_string
	call print_ax_withprefix_dec
	
	mov dx, offset base16str
	call print_string
	call print_ax_withprefix_hex
